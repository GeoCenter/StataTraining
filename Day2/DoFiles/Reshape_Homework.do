* Description: Reshape homework for Stata Training Day 2
...
* Hint: you may need to add a second variable into the i argument in your reshape
...
* --- Goal:
* In this exercise, we will create a tidy data frame. Since two variables are
* stored in the columns, we will have to do two sequential reshapes.
