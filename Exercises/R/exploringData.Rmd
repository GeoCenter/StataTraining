...
# is.na will return a vector of booleans (true/falses).  We can then count how many rows are true -- missing data.
...
# As an aside... this method shows every value for the fragileIdx, which is cool, but overkill for what we want.  We can add in 
