...
·	Import data
o	Start with help import to see help file and various import methods
o	Use insheet for csv file
·	Save data
·	See how to look at the data through browse
·	Destring data [start with fiscalyears, quarters and spending/amount as string that easy to destring; can go deeper into instring in week 2]
...
·	Add a data label (label variable) to the new variable to describe it and format it to have comma
...
·	Use egen to create a ranking and fiscal year mean
